            ...
            <div className="max-w-7xl mx-auto px-6 md:px-16 py-12">
                ...
                >
                    <p className="text-xl mb-8 leading-relaxed text-gray-300">
                        At JOOD, we're passionate about making your travel
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-16">
                    ...
                    >
                        ...
                        <div className="space-y-4 text-gray-300 leading-relaxed">
                            <p>
                                ...
                                JOOD started with a simple idea: to create a
                    ...
                    >
                        ...
                        <div className="space-y-4 text-gray-300 leading-relaxed">
                            ...
                            <p>
                                JOOD aims to be the bridge connecting cultures,
                                people, and places, fostering understanding and
                ...
                >
                    <h2 className="text-3xl font-bold mb-8">
                        Why Choose <span className="text-green-500">JOOD</span>?
                    </h2>
                ...
                >
                    <h2 className="text-2xl font-bold mb-4">
                        ...
                        <span className="text-green-400">JOOD</span>?
                    </h2>
